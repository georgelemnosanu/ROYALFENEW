...
export default function ProductPage({ params }: PageProps) {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      toast.error("Eroare la adăugarea în coș. Încearcă din nou.")
    } finally {
  ...
  const handleSubmitReview = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("Eroare la trimiterea recenziei. Încearcă din nou.")
    }
  }
            ...
            <div className="space-y-6 sm:space-y-8">
              <div>
                ...
                <div className="text-sm text-[#FFD700]/60">
                  Stoc: {product.stock > 0 ? `${product.stock} bucăți` : "Indisponibil"}
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-6 sm:pt-8">
                ...
                >
                  ...
                  {addingToCart ? "SE ADAUGĂ..." : product.stock === 0 ? "INDISPONIBIL" : "ADAUGĂ ÎN COȘ"}
                </Button>
                <Button
                  variant="outline"
